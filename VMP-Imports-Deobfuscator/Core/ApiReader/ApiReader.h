...
#include "../Process/ProcessAccessHelp.h"
#include "../Utils/Thunks/Thunks.h"
...
public:
	...
	static std::unordered_map<DWORD_PTR, ImportModuleThunk>* moduleThunkList; //store found apis
	...
	void readAndParseIAT(DWORD_PTR addressIAT, DWORD sizeIAT, std::unordered_map<DWORD_PTR, ImportModuleThunk>& moduleListNew);
